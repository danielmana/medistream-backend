...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'medistream_customuser', (
            ...
            ('speciality', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='specialities', null=True, to=orm['medistream.Speciality'])),
        ))
        db.send_create_signal(u'medistream', ['CustomUser'])

        # Adding M2M table for field groups on 'CustomUser'
        m2m_table_name = db.shorten_name(u'medistream_customuser_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('customuser', models.ForeignKey(orm[u'medistream.customuser'], null=False)),
        ...
        m2m_table_name = db.shorten_name(u'medistream_customuser_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('customuser', models.ForeignKey(orm[u'medistream.customuser'], null=False)),
        ...
        db.create_table(u'medistream_speciality', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'medistream', ['Speciality'])


    def backwards(self, orm):
        # Deleting model 'CustomUser'
        db.delete_table(u'medistream_customuser')

        # Removing M2M table for field groups on 'CustomUser'
        db.delete_table(db.shorten_name(u'medistream_customuser_groups'))

        # Removing M2M table for field user_permissions on 'CustomUser'
        db.delete_table(db.shorten_name(u'medistream_customuser_user_permissions'))

        # Deleting model 'Speciality'
        db.delete_table(u'medistream_speciality')
