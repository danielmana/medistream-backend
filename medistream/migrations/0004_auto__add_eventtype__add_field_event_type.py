...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'medistream_eventtype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'medistream', ['EventType'])

        # Adding field 'Event.type'
        db.add_column(u'medistream_event', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='events', null=True, to=orm['medistream.EventType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'EventType'
        db.delete_table(u'medistream_eventtype')

        # Deleting field 'Event.type'
        db.delete_column(u'medistream_event', 'type_id')
